...
<title>Main Pagee</title>
	...
	<link href="/css/common.css?f" rel="stylesheet" type="text/css"><!-- 공통 -->
	<link href="/css/dialog.css" rel="stylesheet" type="text/css"><!-- 모든 다이알로그 공통 -->
	<link href="/css/main.css" rel="stylesheet" type="text/css"><!-- main화면 -->
</head>
<body>
		<nav class="navbar">
        ...
        <div class="navbar_logo">
        	<a href="/main">
        	<i class="fas fa-plane-departure"></i><span>Airline Total Management</span><i class="fas fa-plane-departure"></i>
            </a>
        </div>
        
        <ul class="navbar_menu">
            <li id="category1" class="menuBtn"><a href="/main/flight">항공편 조회</a></li>
            <li id="category2" class="menuBtn"><a href="/main/reservation">예약 조회</a></li>
